...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 03 avr. 2026 à 12:05
...
CREATE TABLE `tickets` (
  ...
  `statut` enum('admin','technicien','user') NOT NULL,
  `user_id` int(11) NOT NULL,
  `created` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Problème connexion', 'Impossible de se connecter', '', 1, '2026-04-03 09:03:17'),
(2, 'Bug affichage', 'Le tableau ne s’affiche pas correctement', '', 1, '2026-04-03 09:03:17'),
(3, 'Erreur paiement', 'Paiement refusé sans raison', '', 1, '2026-04-03 09:03:17'),
(4, 'Suggestion amélioration', 'Ajouter un mode sombre', '', 1, '2026-04-03 09:03:17'),
(5, 'Problème lenteur', 'Le site est très lent', '', 1, '2026-04-03 09:03:17');
